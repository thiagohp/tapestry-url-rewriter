...
/**
 * Tests {@linkplain org.apache.tapestry5.urlrewritter.SimpleRequestWrapper} and
...
public class SimpleRequestWrapperTest extends TestBase {
	...
	public void delegating_methods() throws IOException {
		...
		SimpleRequestWrapper request = new SimpleRequestWrapper(mock,
				"localhost", "path");
...
//		testConstructorWithoutServerName(request, null, true);
	...
	private void testConstructorWithServerName(Request request,
			String serverName, String path, boolean expectException) {
